...
### MCDA
<!-- when updating table content please write it as a whole again or there will be some format error -->
...
| Number | Indicator | Definition | Formula | Source of Data | Reference |
|--------|-----------|------------|---------|----------------|-----------|
...
|1-6|Nuisance from Urban Barriers|||||
...
Accuracy/Reflection: the CIR map come from , the threshold of 0.2 is based on research from 
