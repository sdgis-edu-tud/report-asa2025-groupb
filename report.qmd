...
```{r}
hot_nights <- "C:/Users/stepa/OneDrive/Documents/GEO/ARFW0501/report-asa2025-groupb/files/promote_climate_adaptation/10y_aggregated_hotnights.gpkg"
UHI_max <- "C:/Users/stepa/OneDrive/Documents/GEO/ARFW0501/report-asa2025-groupb/files/promote_climate_adaptation/UHI_max.gpkg"
...
plot(hn["X10y_hotnights"], border = NA, main = "Number of Hot nights (>22°C) aggregated between 2015-24")
plot(uhi["UHI_max_norm"], border = NA, main = "UHI max")
...
# Plot combined heat risk index as a true spatial map
plot(combined["heat_risk_index"], border = NA, main = "Combined Heat Risk Index (Standardized)")
