...
<!-- if switching to when updating table content please write it as a whole again or there will be some format error -->
...
::::: grid
::: g-col-6
![](report_files/libs/imgs/2-3_Greenscapes_basemap.png){#fig-CIR width="100%"}
:::

::: g-col-6
![](report_files/libs/imgs/2-4_GreensLandusemap.png){#fig-index width="100%"}
:::
:::::
...
::::: grid
::: g-col-6
![](report_files/libs/imgs/2-5_DATA_Species_Richness.jpg){#fig-CIR width="100%"}
:::

::: g-col-6
![](report_files/libs/imgs/2-6_Species_Richness_index.jpg){#fig-index width="100%"}
:::
:::::
...
::::: grid
::: g-col-6
![](report_files/libs/imgs/2-7_Industries_basemap.png){#fig-CIR width="100%"}
:::

::: g-col-6
![](report_files/libs/imgs/2-8_nuisence_by_industries.png){#fig-index width="100%"}
:::
:::::
...
::::: grid
::: g-col-6
![](report_files/libs/imgs/2-9_road_typologies_data.jpg){#fig-CIR width="100%"}
:::

::: g-col-6
![](report_files/libs/imgs/2-10_traffic_noise_disturbance_index.jpg){#fig-index width="100%"}
:::
:::::
...
::::: grid
::: g-col-6
![](report_files/libs/imgs/2-11_urban_barrier_data.jpg){#fig-CIR width="100%"}
:::

::: g-col-6
![](report_files/libs/imgs/2-12_urban_barrier_index.jpg){#fig-index width="100%"}
:::
:::::
...
::: {layout-ncol="2"}
![](report_files/libs/imgs/4-3_Landusemap_basemap.png){width="48%"} ![](report_files/libs/imgs/4-4_Landusemap_urbanisation.png){width="48%"}
:::
