...
While the project aimed to follow a structured and re-aplicable approach, several limitations affect the reproducibility of the analysis. 
...
Reflection: The healthy index of vegetation shows the areas where there is more photosynthetic activity and therefore more healthy vegetation. It's based on the NDVI index.\
...
Reflection: The natural land use density shows the difference between urban and natural land use, visualizing the tiles with the higher area of green space.\
...
Reflection: Species richness shows the places where based on an understanding of the type of green space, the richness of species is higher\
...
Reflection: Tyles with more presence of industries are considered places more exposed to the different contaminants resulting from the industrial activity, creating dangerous spaces for the ecosystem in these spaces.\
