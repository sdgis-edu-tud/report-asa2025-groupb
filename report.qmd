...
1.  **Enrich Biodiversity**\
    ...
    1-3. **Species Richness**: different types of natural land use indicate different degree of species richness which provides different condition for interventions aiming for enriching biodiversity, for example forests imply higher biodiversity and farmlands lower.\
...
::: {#fig-ndvi layout-ncol="2"}
![](report_files/libs/imgs/2-1.jpg){width="48%"} ![](report_files/libs/imgs/2-2_vegetation_health_index.jpg){width="48%"}
:::
...
::: {#fig-naturallanduse layout-ncol="2"}
![](report_files/libs/imgs/2-3and5_Greenscapes_base_map.jpg){width="48%"} ![](report_files/libs/imgs/2-4_GreensLandusemap.png){width="48%"} Natual Land Use Density
:::
...
::: {#fig-species_richness layout-ncol="2"} ![](report_files/libs/imgs/2-5_DATA_Species_Richness.jpg){width="48%"} ![](report_files/libs/imgs/2-6_Species_Richness_index.jpg){width="48%"} :::
...
::: {layout-ncol="2"}
![](report_files/libs/imgs/2-7_Industries_basemap.jpg){width="48%"} ![](report_files/libs/imgs/2-8_nuisence_by_industries.png){width="48%"}
:::
...
::: {layout-ncol="2"}
![](report_files/libs/imgs/2-9_road_typologies_data.jpg){width="48%"} ![](report_files/libs/imgs/2-10_traffic_noise_disturbance_index.jpg){width="48%"}
:::
...
::: {layout-ncol="2"}
![](report_files/libs/imgs/2-11_urban_barrier_data.jpg){width="48%"} ![](report_files/libs/imgs/2-12_urban_barrier_index.jpg){width="48%"}
:::
...
::: {layout-ncol="2"}
![](report_files/libs/imgs/3-1_flood_data.jpg){width="48%"} ![](report_files/libs/imgs/3-2_flood_risk_index.jpg){width="48%"}
:::
...
::: {layout-ncol="2"}
![](report_files/libs/imgs/3-3_permeability_data.jpg){width="48%"} ![](report_files/libs/imgs/3-4_permeability_index.jpg){width="48%"}
:::
...
::: {layout-ncol="2"}
![](report_files/libs/imgs/4-1_population_data.jpg){width="48%"} ![](report_files/libs/imgs/4-2_population_index.jpg){width="48%"}
:::
...
::: {layout-ncol="2"}
![](report_files/libs/imgs/4-3_Landusemap_basemap.jpg){width="48%"} ![](report_files/libs/imgs/4-4_Landusemap_urbanisation.png){width="48%"}
:::
...
::: {layout-ncol="2"}
![](report_files/libs/imgs/4-5_poi_data.jpg){width="48%"} ![](report_files/libs/imgs/4-6_poi_index.jpg){width="48%"}
:::
...
::: {layout-ncol="2"}
![](report_files/libs/imgs/4-9_local_centrality_data.jpg){width="48%"} ![](report_files/libs/imgs/4-10_local_centrality_index.jpg){width="48%"}
:::
...
::: {layout-ncol="2"}
![](report_files/libs/imgs/4-11_public_transport_data.jpg){width="48%"} ![](report_files/libs/imgs/4-12_public_transport_index.jpg){width="48%"}
:::
...
::: {layout-ncol="2"}
![](report_files/libs/imgs/4-17_attraction_betweeness_data.jpg){width="48%"} ![](report_files/libs/imgs/4-18_attraction_betweeness_index.jpg){width="48%"}
:::
